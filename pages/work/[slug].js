  ...
  return (
    <Layout>
      ...
      <div itemScope itemType="http://schema.org/CreativeWork">
            ...
            {workUrl && (
              <WorkLink href={workUrl} target="_blank" rel="noopener noreferrer">
                ...
                <svg width="22" height="22" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    d="M25.0023 24.4645L24.9169 9.51653M24.9169 9.51653L9.96899 9.43111M24.9169 9.51653L8.5169 25.9165"
                    stroke="black"
                    strokeWidth="2.5"
                  />
                </svg>
        ...
        <Figure>
          <ProgressiveImage src={`${url}?w=2200&q=100`} placeholder="tiny-image.jpg">
            {(src, loading) => (
              <img
                loading="lazy"
        ...
        <GridDescription>
          ...
          <aside>{description && <Side>{documentToReactComponents(description)}</Side>}</aside>
        </GridDescription>
        {images &&
          images.map((image) => {
            const { fields } = image
